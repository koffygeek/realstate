  ...
  <section className='h-full max-h-[640px] mb-8 xl:mb-24'>
    <div className='flex flex-col lg:flex-row'>
      ...
      text-center lg:text-left justify-center flex-1 px-4 lg:px-0'>
        ...
        quae, accusamus necessitatibus molestias illo hic voluptatum
        distinctio asperiores qui molestiae! Ab asperiores, fugit eveniet
        praesentium laudantium obcaecati a corrupti maiores.
        </p>
      </div>
      {/* image */}
