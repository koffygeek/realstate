  ...
  return (
    ...
    <div className='container mx-auto min-h-[600px] mb-14'>
      ...
      <div className='flex flex-col item-start gap-8 lg:flex-row'>
        ...
        <div className='flex-2 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form className='flex flex-col gap-y-4'>
            ...
            placeholder='Phone*'
            />
            <textarea className='border border-gray-300 focus-violet-700 outline-none resize-none rounded w-full p-4 h-36 text-sm text-gray-400'
            placeholder='Message*'
